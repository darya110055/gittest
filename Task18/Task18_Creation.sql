...
-- Дамп данных таблицы furniture.buyers: ~0 rows (приблизительно)
...
-- Дамп данных таблицы furniture.furniture: ~0 rows (приблизительно)
...
-- Дамп данных таблицы furniture.sales: ~0 rows (приблизительно)
...
-- Дамп данных таблицы furniture.treaties: ~0 rows (приблизительно)
